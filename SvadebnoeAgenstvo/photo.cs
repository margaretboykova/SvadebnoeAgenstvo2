...
namespace SvadebnoeAgenstvo
{
    public partial class photo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            command.Parameters.Add("@ns", MySqlDbType.VarChar).Value = "Фотограф";
            ...
            command.Parameters.Add("@pph", MySqlDbType.Bit).Value = checkBox1.Checked; 
            command.Parameters.Add("@pv", MySqlDbType.Bit).Value = checkBox2.Checked;
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            { //Если объекты типа string
                comboBox3.Items.AddRange(new string[] { "Алексеев Василий Васильевич", "Дегтярёв Лев Анатольевич" });
            }
            if (comboBox2.SelectedItem == "Детская д.2")
            { //Если объекты типа string
                comboBox3.Items.AddRange(new string[] { "Мартиросян Гарик Юрьевич" });
            }
            if (comboBox2.SelectedItem == "А.Матросова д.5")
            { //Если объекты типа string
                comboBox3.Items.AddRange(new string[] { "Житенев Алексей Алексеевич" });
            }
        }
    }
}
